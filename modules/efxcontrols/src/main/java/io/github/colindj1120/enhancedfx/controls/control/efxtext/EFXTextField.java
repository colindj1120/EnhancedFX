...
import io.github.colindj1120.enhancedfx.controls.control.efxtext.base.InnerTextField;
...
public class EFXTextField extends EFXTextBase<TextField> implements InnerTextField<TextField> {
    ...
    /**
     * Constructs a new {@code EFXTextField} with no initial text.
     *
     * <p>
     * This constructor initializes a blank {@code EFXTextField} component. It performs any necessary setup inherited from the superclass and prepares the text field for use, with no initial text set. This
    ...
    /**
     * Constructs a new {@code EFXTextField} with the specified initial text.
     *
     * <p>
     * This constructor allows for the creation of an {@code EFXTextField} with preset text, facilitating scenarios where the initial content is known at the time of the text field's instantiation. This
     ...
     */
    public EFXTextField(String text) {
        super();
     ...
     *
     * @return The {@code EFXTextField} instance represented by {@code this}, confirming the current object as the operative control. This design facilitates direct access to the enhanced text field's
    ...
    protected Skin<?> createDefaultSkin() {
        return new EFXTextFieldSkin(this);
    }
    ...
    /**
     * Returns a EFXBooleanBinding representing the property that indicates whether float animation is enabled.
     *
