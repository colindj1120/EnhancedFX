 ...
 */
package io.github.colindj1120.enhancedfx.controls.simplecontrol.efxlabeled.efxbuttons;

import io.github.colindj1120.enhancedfx.base.css.StyleablePropertiesManager;
import io.github.colindj1120.enhancedfx.utils.exceptions.SkinException;
import io.github.colindj1120.enhancedfx.controls.simplecontrol.base.RippleControls;
import io.github.colindj1120.enhancedfx.controls.simplecontrol.efxcontrol.base.EFXControlBase;
import io.github.colindj1120.enhancedfx.controls.simplecontrol.efxlabeled.efxbuttons.base.InnerToggleButton;
...
public class EFXToggleButton extends EFXSupportedControl<ToggleButton> implements RippleControls, InnerToggleButton<ToggleButton> {
    ...
    public static EFXToggleButton create() {
        return EFXControlBase.create(EFXToggleButton.class);
    }

    public static EFXToggleButton create(String text) {
        EFXToggleButton efxToggleButton = EFXControlBase.create(EFXToggleButton.class);
        efxToggleButton.setupButton(text, null);
        return efxToggleButton;
    }

    public static EFXToggleButton create(String text, Node graphic) {
        EFXToggleButton efxToggleButton = EFXControlBase.create(EFXToggleButton.class);
        efxToggleButton.setupButton(text, graphic);
        return efxToggleButton;
    }

    protected EFXToggleButton() {
        super();
    }

    private void setupButton(String text, Node graphic) {
        Optional.ofNullable(graphic)
                .ifPresent(g -> innerControl.setGraphic(graphic));
