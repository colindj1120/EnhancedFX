 ...
 *
 * <p>`TextMode` is utilized to specify how text elements should be displayed, impacting their aesthetic and functional roles within the user interface. It supports the application's flexibility in UI design,
 * allowing for dynamic adjustments to the presentation of text according to context or user preference.</p>
 *
 * <p>The enum provides several utility methods to work with the mode names, facilitating their use in logging, user interfaces, or any context where a string representation is required. These methods include
 * converting the name to a standard, lowercase, or title case format.</p>
 *
 ...
 * </ul>
 *
 * <p>This enumeration is integral to the flexible design of the application's user interface, allowing for consistent yet adaptable text presentation.</p>
 *
