 ...
 */
package io.github.colindj1120.enhancedfx.controls.control.efxcontrol.base;
 ...
 *
 * <p>
 * {@code EFXControlBase} provides a structured approach to extending JavaFX's {@link Control} class, offering a foundation upon which custom controls with additional functionalities and stylings can be
 ...
 * <p>
 * <ul>
 *     <li><strong>EFXTheme Management:</strong> Supports dynamic theme changes, allowing subclasses to implement specific logic for loading new themes and adjusting the control's appearance accordingly.</li>
 ...
 * <p>
 * <em>Subclasses of {@code EFXControlBase} are required to implement the following abstract methods:</em>
 * <ul>
 *     <li>{@link #getControl()} - Retrieves the specific instance of the enhanced control.</li>
 *     <li>{@link #loadNewTheme(Observable, EFXTheme, EFXTheme)} - Handles theme changes.</li>
