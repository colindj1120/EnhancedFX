...
import io.github.colindj1120.enhancedfx.base.factory.ExtendedStyleableIntegerPropertyFactory;
...
public abstract class EFXTextBase<T extends TextInputControl> extends EFXSupportedControl<T> implements InnerTextInputControl<T> {
    ...
    protected EFXStyleableObjectProperty<State>                     maxCharCountState;
    ...
    static {
        ...
        CssFactory<EFXTextField, State> maxCharCountStateCssFactory;
        maxCharCountStateCssFactory = CssFactory.<EFXTextField, State>create()
        ...
        CssFactory<EFXTextField, Number> maxCharCountCssFactory;
        maxCharCountCssFactory = CssFactory.<EFXTextField, Number>create()
     ...
     *
     * <p>
     * This constructor initializes the {@code EFXTextBase} component with default settings, ensuring it is ready for use or further customization. It is designed to set up essential properties, listeners,
     * or default styles that are common to all instances of {@code EFXTextBase}. The call to the superclass constructor ({@code super()}) ensures that any initialization logic defined in the superclass is
