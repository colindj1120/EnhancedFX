package io.github.colindj1120.enhancedfx.controls.control.efxtext;
...
import io.github.colindj1120.enhancedfx.controls.control.efxtext.base.InnerTextArea;
...
/**
 * The {@code EFXTextArea} class is an extension of the {@link EFXTextBase} tailored specifically for {@link TextArea} controls within the EnhancedFX library. It encapsulates functionalities that are
...
public class EFXTextArea extends EFXTextBase<TextArea> implements InnerTextArea<TextArea> {
    ...
    private EFXStyleableObjectProperty<State> titleState;
    ...
    static {
        ...
        CssFactory<EFXTextArea, State> titleStateFactory;
        titleStateFactory = CssFactory.<EFXTextArea, State>create()
    ...
    /**
     * Constructs a new {@code EFXTextArea} instance with no initial text.
     *
     * <p>
     * This default constructor initializes an empty {@code EFXTextArea}, setting up the foundational configuration inherited from the superclass and preparing the text area for subsequent configuration or
    ...
    /**
     * Constructs a new {@code EFXTextArea} instance with the specified initial text.
     *
     * <p>
     * This constructor provides a convenient way to create an {@code EFXTextArea} pre-populated with given text, streamlining the setup for use cases where initial content is known at construction time.
     ...
     */
    public EFXTextArea(String text) {
        super();
    ...
    /**
     * Retrieves the current instance of {@code EFXTextArea}. This method is an implementation of an abstract method from the superclass, designed to return the specific control instance that it
     * represents. In the context of this class, it returns {@code this}, indicating that the current object itself is the {@code EFXTextArea} control in use.
     *
     * <p>
     ...
     * </p>
     *
     * @return the current instance of {@code EFXTextArea}, signifying the control itself. This facilitates direct interaction with the enhanced features and behaviors specific to the
     *         {@code EFXTextArea}.
     */
    @Override
    ...
    /**
     * This method builds upon {@code setupStyleableProperties} from the superclass, and configures the styleable properties specific to this {@code EFXTextArea} control instance such as {@code titleState}
     * to {@code EFXTextArea} control's capabilities.
     *
     * <p>
     ...
     *
     * <p>
     * This method builds upon {@code setupControl} from the superclass, applying an additional stylesheet and style class specific to {@code EFXTextArea}. The configuration ensures the control adheres to
    ...
    protected Skin<?> createDefaultSkin() {
        return new EFXTextAreaSkin(this);
    }
