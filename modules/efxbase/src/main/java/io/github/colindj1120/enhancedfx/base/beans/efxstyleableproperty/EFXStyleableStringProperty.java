 ...
 * </ul>
 * Additionally, {@code EFXStyleableStringProperty} is designed with a focus on customization and ease of use,
 ...
 * <em>Example Usage:</em>
 * <pre>{@code
 * EFXStyleableStringProperty customProperty = new EFXStyleableStringProperty.Builder()
 *         .bean(this)
 *         .name("customProperty")
 ...
 * @see TriConsumer
 */
public class EFXStyleableStringProperty extends StyleableStringProperty implements EFXStyleablePropertyBase {
     ...
     * </ul>
     * <p>
     * The {@code build()} method finalizes the construction of the {@code EFXStyleableStringProperty}, ensuring that all
     ...
     *         .build();
     * </pre>
     * This approach to constructing an {@code EFXStyleableStringProperty} provides a clear and modular way to configure
    ...
    public static class Builder {
         ...
         *
         * <p>
         * After passing all checks, the method constructs a new {@code EFXStyleableStringProperty}, optionally setting
         ...
         * </p>
         *
         * @return A fully configured {@code EFXStyleableStringProperty} instance.
         *
         * @throws IllegalArgumentException
         *         if any required configuration is missing or incorrectly specified.
         */
        public EFXStyleableStringProperty build() {
            invalidatorsNullCheck(this.invalidatedVoidCallback, this.invalidatedPropCallback, this.invalidatedCachedCallback, EFXStyleableStringProperty.class);
            nullCheck(bean, "EFXStyleableStringProperty Bean", EFXStyleableStringProperty.class);
            nullCheck(name, "EFXStyleableStringProperty Name", EFXStyleableStringProperty.class);
            nullCheck(cssMetaData, "EFXStyleableStringProperty CssMetaData", EFXStyleableStringProperty.class);
