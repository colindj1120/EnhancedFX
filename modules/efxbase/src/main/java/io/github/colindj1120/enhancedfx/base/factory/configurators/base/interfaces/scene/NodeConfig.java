 ...
 */
package io.github.colindj1120.enhancedfx.base.factory.configurators.base.interfaces.scene;
...
/**
 * The {@code NodeConfig} interface defines a comprehensive suite of configuration and manipulation methods for {@link Node} objects within JavaFX applications. This interface is designed to facilitate advanced
 * customization, dynamic property binding, event handling, and layout adjustments for nodes, thereby enhancing the flexibility and interactivity of user interfaces.
 *
 * <p>
 ...
 *     <li>EFXStyle management to apply CSS styles dynamically, enabling runtime changes to the node's appearance.</li>
...
public interface NodeConfig {
    ...
    /**
     * Removes a change listener from the disabled property. Note: This is for components that have a property directly named "disabled".
     *
     * @param changeListener
     *         the change listener to remove
     *
    ...
    /**
     * Removes an invalidation listener from the disabled property. Note: This is for components that have a property directly named "disabled".
     *
     * @param invalidationListener
     *         the invalidation listener to remove
     *
    ...
    /**
     * Removes a change listener from the disabled property. Note: This is typically for the property controlling whether a component is enabled or disabled.
     *
     * @param changeListener
     *         the change listener to remove
     *
    ...
    /**
     * Removes an invalidation listener from the disabled property. Note: This is typically for the property controlling whether a component is enabled or disabled.
     *
     * @param invalidationListener
     *         the invalidation listener to remove
     *
    ...
    /**
     * Removes a change listener from the effect property of the component. This listener is notified whenever the visual effect is applied to the component changes.
     *
     * @param changeListener
     *         the change listener to remove
     *
    ...
    /**
     * Removes an invalidation listener from the effect property of the component. This listener is notified whenever the effect property becomes invalid.
     *
     * @param invalidationListener
     *         the invalidation listener to remove
     *
    ...
    /**
     * Removes a change listener from the event dispatcher property of the component. This listener is notified of changes to the event dispatcher which handles the routing of events to the component.
     *
     * @param changeListener
     *         the change listener to remove
     *
    ...
    /**
     * Removes an invalidation listener from the event dispatcher property of the component. This listener is notified whenever the event dispatcher property becomes invalid.
     *
     * @param invalidationListener
     *         the invalidation listener to remove
     *
    ...
    /**
     * Removes a change listener from the focused property of the component. This listener is notified whenever the focus state of the component changes, indicating whether it is the current target for keyboard
     * input.
     *
     * @param changeListener
     *         the change listener to remove
    ...
    /**
     * Removes a change listener from the layout bounds property of the component. This listener is notified of changes to the component's layout bounds.
     *
     * @param changeListener
     *         the change listener to remove
     *
    ...
    /**
     * Establishes a bidirectional binding between the cache property of the component and another property indicating whether caching is enabled.
     *
     * @param property
    ...
    /**
     * Establishes a bidirectional binding between the clip property of the component and another property representing a clipping node.
     *
     * @param property
    ...
    /**
     * Establishes a bidirectional binding between the cursor property of the component and another property indicating the cursor type.
     *
     * @param property
    ...
    /**
     * Binds the focus-traversable property of the component to another observable value indicating whether the component can gain focus.
     *
     * @param observableValue
    ...
    /**
     * Binds the mouse transparent property of the component to another observable value indicating whether the component is mouse transparent.
     *
     * @param observableValue
    ...
    /**
     * Establishes a bidirectional binding between the onContextMenuRequested event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Removes a bidirectional binding between the onContextMenuRequested event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Establishes a bidirectional binding between the onInputMethodTextChanged event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Removes a bidirectional binding between the onInputMethodTextChanged event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Establishes a bidirectional binding between the onMouseDragEntered event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Establishes a bidirectional binding between the onMouseDragReleased event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Establishes a bidirectional binding between the onRotationFinished event handler property of the component and another property.
     *
     * @param property
    ...
    /**
     * Binds the onScroll event handler property of the component to another observable value. This event occurs when a scroll gesture is detected.
     *
     * @param observableValue
    ...
    /**
     * Binds the onScrollFinished event handler property of the component to another observable value. This event occurs when a scroll gesture has finished.
     *
     * @param observableValue
    ...
    /**
     * Binds the onScrollStarted event handler property of the component to another observable value. This event occurs when a scroll gesture is started.
     *
     * @param observableValue
    ...
    /**
     * Binds the onSwipeDown event handler property of the component to another observable value. This event occurs when a swipe down gesture is detected.
     *
     * @param observableValue
    ...
    /**
     * Binds the onSwipeLeft event handler property of the component to another observable value. This event occurs when a swipe left gesture is detected.
     *
     * @param observableValue
    ...
    /**
     * Adds an {@link EventHandler} as an event filter to the component. Event filters get the opportunity to process events before event handlers. If an event filter consumes an event, it will not propagate
     * further to event handlers.
     *
     * @param <S>
    ...
    /**
     * Removes an {@link EventHandler} from the set of event filters for a specific event type. This allows for dynamic modification of event processing behavior.
     *
     * @param <S>
     *         the specific {@code Event} subclass
     * @param eventType
    ...
    /**
     * Removes an {@link EventHandler} from the set of event handlers for a specific event type. This enables changing how events are processed at runtime.
     *
     * @param <S>
     *         the specific {@code Event} subclass
     * @param eventType
    ...
    /**
     * Sets the node orientation for the component, determining the direction (left-to-right or right-to-left) in which the component is laid out.
     *
     * @param value
    ...
    /**
     * Sets the style class at the specified index of the component.
     *
     * @param index
     *         the index at which to set the style class
     * @param element
     *         the style class to set
     *
     * @return the current instance for method chaining
     */
    NodeConfig setStyleClass(int index, String element);

    /**
     * Sets all the style classes of the component to the specified elements.
     *
     * @param elements
     *         the elements to set as style classes
     *
     * @return the current instance for method chaining
     */
    NodeConfig setAllStyleClasses(String... elements);

    /**
     * Sets all the style classes of the component to the elements in the specified collection.
     *
     * @param col
     *         the collection containing the elements to set as style classes
     *
     * @return the current instance for method chaining
     */
    NodeConfig setAllStyleClasses(Collection<? extends String> col);

    /**
     * Sets the transform class at the specified index of the component.
     *
     * @param index
     *         the index at which to set the transform class
     * @param element
     *         the transform class to set
     *
     * @return the current instance for method chaining
     */
    NodeConfig setTransformClass(int index, Transform element);

    /**
     * Sets all the transform classes of the component to the specified elements.
     *
     * @param elements
     *         the elements to set as transform classes
     *
     * @return the current instance for method chaining
     */
     NodeConfig setAllTransformClasses(Transform... elements);

    /**
     * Sets all the transform classes of the component to the elements in the specified collection.
     *
     * @param col
     *         the collection containing the elements to set as transform classes
     *
     * @return the current instance for method chaining
     */
    NodeConfig setAllTransformClasses(Collection<? extends Transform> col);
    ...
    /**
     * Triggers the application of CSS to this component. This method is useful when manual control over the timing of CSS application is needed, such as after adding or modifying style classes.
     *
     * @return the current instance for method chaining
     */
    NodeConfig applyCss();
