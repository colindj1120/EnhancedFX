...
import io.github.colindj1120.enhancedfx.base.factory.configurators.base.interfaces.controls.ButtonConfig;
 ...
 * @see ButtonConfig
 */
public class ButtonConfigurator<T extends ButtonConfigurator<T>> extends ButtonBaseConfigurator<T> implements ButtonConfig {
    /**
     ...
     */
    @Override
    public ButtonConfigurator setStyleClass(int index, String element) {
     ...
     */
    @Override
    public ButtonConfigurator setAllStyleClasses(String... elements) {
     ...
     */
    @Override
    public ButtonConfigurator setAllStyleClasses(Collection<? extends String> col) {
     ...
     */
    @Override
    public ButtonConfigurator setTransformClass(int index, Transform element) {
     ...
     */
    @Override
    public ButtonConfigurator setAllTransformClasses(Transform... elements) {
     ...
     */
    @Override
    public ButtonConfigurator setAllTransformClasses(Collection<? extends Transform> col) {
