...
import io.github.colindj1120.enhancedfx.base.factory.configurators.base.interfaces.scene.NodeConfig;
...
public abstract class NodeConfigurator extends ConfiguratorBase implements NodeConfig {
     ...
     */
    @Override
    public NodeConfig setStyleClass(int index, String element) {
        node.getStyleClass().set(index, element);
        return this;
    }
     ...
     */
    @Override
    public NodeConfig setAllStyleClasses(String... elements) {
        node.getStyleClass().setAll(elements);
        return this;
    }
     ...
     */
    @Override
    public NodeConfig setAllStyleClasses(Collection<? extends String> col) {
        node.getStyleClass().setAll(col);
        return this;
    }
     ...
     */
    @Override
    public NodeConfig setTransformClass(int index, Transform element) {
        node.getTransforms().set(index, element);
        return this;
    }
     ...
     */
    @Override
    public NodeConfig setAllTransformClasses(Transform... elements) {
        node.getTransforms().setAll(elements);
        return this;
    }
     ...
     */
    @Override
    public NodeConfig setAllTransformClasses(Collection<? extends Transform> col) {
        node.getTransforms().setAll(col);
        return this;
    }
