...
public class EFXStyleableIntegerProperty extends StyleableIntegerProperty implements EFXStyleablePropertyBase {
     ...
     */
    protected EFXStyleableIntegerProperty(Builder builder, int defaultValue) {
        super(defaultValue);
    ...
    public static class Builder {
        ...
        /**
         * Builder class for constructing {@link EFXStyleableIntegerProperty} instances.
         *
         * <p>
        ...
        public EFXStyleableIntegerProperty build() {
            ...
            return Optional.ofNullable(defaultValue)
                           ...
                           .orElse(new EFXStyleableIntegerProperty(this, 0));
        }
    }
}
