 ...
 *
 * <p>Ripple effects are visual indicators of interaction with a UI component, such as a button click or a touch event. The shape of the ripple can significantly affect the user's perception and understanding
 * of the interaction. By offering multiple ripple shapes, EnhancedFX enables developers to customize the user experience to fit the design language and functional requirements of their applications.</p>
 *
 ...
 * </ul>
 *
 * <p>This enumeration plays a crucial role in the EnhancedFX framework, allowing for the customization of ripple effects to enhance user interaction and visual feedback across a wide range of UI
 * components.</p>
 *
...
public enum EFXRippleShape {
    ...
    /**
     * Constructs a new EFXRippleShape object.
     */
    EFXRippleShape() {}
