 ...
 *     HBox hbox = new HBox();
 *     EFXUIUtils.bindBackgrounds(vbox, hbox); // vbox's background now follows hbox's
 *
...
public class EFXUIUtils {
    ...
    public static Pos convertToBaseline(Pos alignment) {
        ...
        return switch (alignment) {
            case Pos.TOP_LEFT, Pos.CENTER_LEFT, Pos.BOTTOM_LEFT, Pos.BASELINE_LEFT -> Pos.BASELINE_LEFT;
            case Pos.TOP_CENTER, Pos.CENTER, Pos.BOTTOM_CENTER, Pos.BASELINE_CENTER -> Pos.BASELINE_CENTER;
            case Pos.TOP_RIGHT, Pos.CENTER_RIGHT, Pos.BOTTOM_RIGHT, Pos.BASELINE_RIGHT -> Pos.BASELINE_RIGHT;
        };
    }
