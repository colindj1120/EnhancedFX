 ...
 * BooleanProperty booleanProperty = EFXExpressionUtils.expressionToBooleanProperty(booleanExpression);
 *
 * IntegerExpression integerExpression = ...;
 * IntegerProperty integerProperty = EFXExpressionUtils.expressionToIntegerProperty(integerExpression);
 *
 * StringExpression stringExpression = ...;
 * StringProperty stringProperty = EFXExpressionUtils.expressionToStringProperty(stringExpression);
 * }</pre>
 *
 ...
 * @see FloatProperty
 */
public class EFXExpressionUtils {
    /**
     * Private constructor to prevent instantiation of the {@code EFXExpressionUtils} class.
     *
     * <p>
     ...
     * {@code EFXExpressionUtils}.
     * </p>
     */
    private EFXExpressionUtils() {}
