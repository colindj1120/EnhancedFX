...
public class LongStyleConverter extends StyleConverter<String, Long> {
    ...
    private static class Holder {
        /**
         * The singleton instance of LongStyleConverter.
         */
        static final LongStyleConverter INSTANCE = new LongStyleConverter();
     ...
     */
    private LongStyleConverter() {}

    /**
     * Provides access to the singleton instance of the {@link LongStyleConverter}.
     *
     * @return The single instance of {@link LongStyleConverter}.
     */
    public static LongStyleConverter getInstance() {
        return Holder.INSTANCE;
    }

    /**
     * Converts a parsed string value into a {@link Long}. This method attempts to parse the string provided by the {@link ParsedValue} argument. If the string cannot be parsed into a valid long, an
     ...
     *
     * @return The converted {@link Long} value.
     *
     * @throws IllegalArgumentException
     *         If the string cannot be converted into a {@link Long}.
     */
    @Override
    public Long convert(ParsedValue<String, Long> value, Font font) {
        try {
            return Long.valueOf(value.getValue());
        }
        catch (NumberFormatException e) {
            throw new IllegalArgumentException("Unable to convert value to Long: " + value.getValue(), e);
        }
    }

    /**
     * Provides a string representation of this {@link LongStyleConverter}.
     *
     * @return The simple name of this class, indicating its purpose.
     */
    @Override
    public String toString() {
        return "LongStyleConverter";
    }
     ...
     * </pre>
     *
     * <p>Usage of this converter facilitates the conversion process in styling mechanisms where multiple long values are needed in sequence, such as in specifying multiple margins or paddings in CSS-like
     * styling languages.</p>
     *
     ...
     *         {@link ParsedValue} objects, each containing a string and its corresponding {@link Long} representation. The output is an array of {@link Long} objects.
     */
    public static final class SequenceConverter extends StyleConverter<ParsedValue<String, Long>[], Long[]> {
        /**
         ...
         */
        public static LongStyleConverter.SequenceConverter getInstance() {
            return LongStyleConverter.Holder.SEQUENCE_INSTANCE;
        }
         ...
         *         The font currently in use, not used in this converter but required by the interface.
         *
         * @return An array of {@link Long} objects corresponding to the converted values.
         */
        @Override
