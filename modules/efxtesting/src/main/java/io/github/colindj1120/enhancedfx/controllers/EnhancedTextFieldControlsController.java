...
public class EnhancedTextFieldControlsController {
    ...
    protected       EFXTextField textField;
    ...
    protected void handleSetStyleDark() {
        checkEnhancedTextFieldLoaded();
        EFXControl.setThemeCssDirectory(EFXTheme.DARK_THEME);
    }

    @FXML
    protected void handleSetStyleLight() {
        checkEnhancedTextFieldLoaded();
        EFXControl.setThemeCssDirectory(EFXTheme.LIGHT_THEME);
    }
    ...
    public void setEnhancedTextField(EFXTextField textField) {
