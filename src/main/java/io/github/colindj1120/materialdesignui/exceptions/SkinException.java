 ...
 */
package io.github.colindj1120.materialdesignui.exceptions;

/**
 * Represents exceptions that may occur during the application of custom skins to UI components within the Material Design UI framework. This class extends {@link RuntimeException} to provide a
