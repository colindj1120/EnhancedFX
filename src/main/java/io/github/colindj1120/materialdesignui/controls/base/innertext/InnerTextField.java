...
public  interface  InnerTextField<T extends TextField> extends InnerTextInputControl<T> {
     ...
     */
    default IntegerProperty prefColumnCountProperty() {return getInnerField().prefColumnCountProperty();}
     ...
     */
    default int getPrefColumnCount() {return getInnerField().getPrefColumnCount();}
     ...
     */
    default void setPrefColumnCount(int value) {getInnerField().setPrefColumnCount(value);}
     ...
     */
    default ObjectProperty<EventHandler<ActionEvent>> onActionProperty() {return getInnerField().onActionProperty();}
     ...
     */
    default EventHandler<ActionEvent> getOnAction() {return getInnerField().getOnAction();}
     ...
     *         the event handler
     */
    default void setOnAction(EventHandler<ActionEvent> value) {getInnerField().setOnAction(value);}
     ...
     */
    default ObjectProperty<Pos> textFieldAlignmentProperty() {return getInnerField().alignmentProperty();}
     ...
     */
    default void setTextFieldAlignment(Pos value) {getInnerField().setAlignment(value);}
     ...
     */
    default Pos getTextFieldAlignment() {return getInnerField().getAlignment();}
}
