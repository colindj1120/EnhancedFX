...
public interface InnerTextInputControl<T extends TextInputControl> extends InnerTextControl<T> {
     ...
     */
    default ObjectProperty<Font> fontProperty() {return getInnerField().fontProperty();}
     ...
     */
    default void setFont(Font value) {getInnerField().setFont(value);}
     ...
     */
    default Font getFont() {return getInnerField().getFont();}
     ...
     */
    default StringProperty promptTextProperty() {return getInnerField().promptTextProperty();}
     ...
     */
    default String getPromptText() {return getInnerField().getPromptText();}
     ...
     */
    default void setPromptText(String value) {getInnerField().setPromptText(value);}
     ...
     */
    default ObjectProperty<TextFormatter<?>> textFormatterProperty() {return getInnerField().textFormatterProperty();}
     ...
     */
    default TextFormatter<?> getTextFormatter() {return getInnerField().getTextFormatter();}
     ...
     */
    default void setTextFormatter(TextFormatter<?> value) {getInnerField().setTextFormatter(value);}
     ...
     */
    default String getText() {return getInnerField().getText();}
     ...
     */
    default void setText(String value) {getInnerField().setText(value);}
    ...
    default StringProperty textProperty() {
        return getInnerField().textProperty();
    }
     ...
     */
    default int getLength() {return getInnerField().getLength();}
     ...
     */
    default ReadOnlyIntegerProperty lengthProperty() {return getInnerField().lengthProperty();}
     ...
     */
    default boolean isEditable() {return getInnerField().isEditable();}
     ...
     */
    default void setEditable(boolean value) {getInnerField().setEditable(value);}
     ...
     */
    default BooleanProperty editableProperty() {return getInnerField().editableProperty();}
     ...
     */
    default IndexRange getSelection() {return getInnerField().getSelection();}
     ...
     */
    default ReadOnlyObjectProperty<IndexRange> selectionProperty() {return getInnerField().selectionProperty();}
     ...
     */
    default String getSelectedText() {return getInnerField().getSelectedText();}
     ...
     */
    default ReadOnlyStringProperty selectedTextProperty() {return getInnerField().selectedTextProperty();}
     ...
     */
    default int getAnchor() {return getInnerField().getAnchor();}
     ...
     */
    default ReadOnlyIntegerProperty anchorProperty() {return getInnerField().anchorProperty();}
     ...
     */
    default int getCaretPosition() {return getInnerField().getCaretPosition();}
     ...
     */
    default ReadOnlyIntegerProperty caretPositionProperty() {return getInnerField().caretPositionProperty();}
     ...
     */
    default boolean isUndoable() {return getInnerField().isUndoable();}
     ...
     */
    default ReadOnlyBooleanProperty undoableProperty() {return getInnerField().undoableProperty();}
     ...
     */
    default boolean isRedoable() {return getInnerField().isRedoable();}
     ...
     */
    default ReadOnlyBooleanProperty redoableProperty() {return getInnerField().redoableProperty();}
     ...
     */
    default String getText(int start, int end) {return getInnerField().getText(start, end);}
     ...
     */
    default void appendText(String text) {getInnerField().appendText(text);}
     ...
     */
    default void insertText(int index, String text) {getInnerField().insertText(index, text);}
     ...
     */
    default void deleteText(IndexRange range) {getInnerField().deleteText(range);}
     ...
     */
    default void deleteText(int start, int end) {getInnerField().deleteText(start, end);}
     ...
     */
    default void replaceText(IndexRange range, String text) {getInnerField().replaceText(range, text);}
     ...
     */
    default void replaceText(final int start, final int end, final String text) {getInnerField().replaceText(start, end, text);}

    /**
     * Cuts the currently selected text from the text field.
     */
    default void cut() {getInnerField().cut();}

    /**
     * Copies the selected text in the text field to the system clipboard.
     */
    default void copy() {getInnerField().copy();}

    /**
     * Pastes the current contents of the clipboard into the text field.
     */
    default void paste() {getInnerField().paste();}
     ...
     */
    default void selectBackward() {getInnerField().selectBackward();}

    /**
     * Selects text in the forward direction from the current cursor position.
     */
    default void selectForward() {getInnerField().selectForward();}

    /**
     * Moves the cursor to the previous word in the text field.
     */
    default void previousWord() {getInnerField().previousWord();}

    /**
     * Moves the cursor to the next word in the text field.
     */
    default void nextWord() {getInnerField().nextWord();}
     ...
     */
    default void endOfNextWord() {getInnerField().endOfNextWord();}

    /**
     * Selects the previous word in the text field.
     */
    default void selectPreviousWord() {getInnerField().selectPreviousWord();}

    /**
     * Selects the next word in the text field.
     */
    default void selectNextWord() {getInnerField().selectNextWord();}

    /**
     * Selects the end of the next word in the text field.
     */
    default void selectEndOfNextWord() {getInnerField().selectEndOfNextWord();}

    /**
     * Selects all the text in the text field.
     */
    default void selectAll() {getInnerField().selectAll();}

    /**
     * Method to navigate back to the home page.
     */
    default void home() {getInnerField().home();}

    /**
     * Ends the text input by moving the cursor to the end of the input field.
     */
    default void end() {getInnerField().end();}

    /**
     * Selects the home position in the text field.
     */
    default void selectHome() {getInnerField().selectHome();}

    /**
     * Selects the end of the text in the text field.
     */
    default void selectEnd() {getInnerField().selectEnd();}
     ...
     */
    default boolean deletePreviousChar() {return getInnerField().deletePreviousChar();}
     ...
     */
    default boolean deleteNextChar() {return getInnerField().deleteNextChar();}
     ...
     */
    default void forward() {getInnerField().forward();}

    /**
     * Moves the cursor in the text field one position backwards.
     */
    default void backward() {getInnerField().backward();}
     ...
     */
    default void positionCaret(int pos) {getInnerField().positionCaret(pos);}
     ...
     */
    default void selectPositionCaret(int pos) {getInnerField().selectPositionCaret(pos);}
     ...
     */
    default void selectRange(int anchor, int caretPosition) {getInnerField().selectRange(anchor, caretPosition);}
     ...
     */
    default void extendSelection(int pos) {getInnerField().extendSelection(pos);}

    /**
     * Clears the contents of the text field.
     */
    default void clear() {getInnerField().clear();}

    /**
     * Deselects any selected text in the text field.
     */
    default void deselect() {getInnerField().deselect();}
     ...
     */
    default void replaceSelection(String replacement) {getInnerField().replaceSelection(replacement);}
     ...
     */
    default void undo() {getInnerField().undo();}

    /**
     * Redoes the last action undone in the text field.
     */
    default void redo() {getInnerField().redo();}

    /**
     * Commits the value entered in the text field.
     */
    default void commitValue() {getInnerField().commitValue();}

    /**
     * Cancels the current edit operation in the text field.
     */
    default void cancelEdit() {getInnerField().cancelEdit();}
}
