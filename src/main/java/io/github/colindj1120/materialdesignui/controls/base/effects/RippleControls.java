 ...
 */
package io.github.colindj1120.materialdesignui.controls.base.effects;
...
/**
 * Defines the contract for UI components that support ripple effects, providing methods to get and set the properties of a {@link RippleEffect}. This interface ensures that implementing classes can
 ...
 * methods delegate operations to the {@link RippleEffect} instance, facilitating a standardized approach to configuring ripple effects across different UI components.
 * </p>
 *
 * <p>
...
public interface RippleControls {
     ...
     */
    default StyleableObjectProperty<Status> rippleStateProperty() {
     ...
     */
    default void setRippleState(Status rippleState) {
     ...
     */
    default RippleShape getRippleShape() {
     ...
     */
    default StyleableObjectProperty<RippleShape> rippleShapeProperty() {
     ...
     */
    default void setRippleShape(RippleShape rippleShape) {
        getRippleEffect().setRippleShape(rippleShape);
    }
     ...
     */
    default RippleShape getRippleClipShape() {
     ...
     */
    default StyleableObjectProperty<RippleShape> rippleClipShapeProperty() {
        return getRippleEffect().rippleShapeProperty();
    }
     ...
     */
    default void setRippleClipShape(RippleShape rippleClipShape) {
     ...
     */
    default Status getRippleFillState() {
     ...
     */
    default StyleableObjectProperty<Status> rippleFillStateProperty() {
     ...
     */
    default void setRippleFillState(Status rippleFillState) {
     ...
     * @see RippleDirection
     */
    default RippleDirection getRippleDirection() {
     ...
     * @see RippleEffect
     */
    default StyleableObjectProperty<RippleDirection> rippleDirectionProperty() {
     ...
     */
    default void setRippleDirection(RippleDirection rippleDirection) {
        getRippleEffect().setRippleDirection(rippleDirection);
    }
     ...
     */
    default StyleableObjectProperty<Status> rippleFadeProperty() {
     ...
     */
    default void setRippleFade(Status rippleFade) {
    ...
    default boolean isRippleFadeEnabled() {
        return getRippleFade() == Status.ENABLED;
    }
     ...
     */
    default Status getDropShadowState() {
     ...
     */
    default StyleableObjectProperty<Status> dropShadowStateProperty() {
     ...
     */
    default void setDropShadowState(Status dropShadowState) {
