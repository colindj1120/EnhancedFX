...
public class RippleEffect extends Region {
    ...
    private void createAndAnimateRipple(MouseEvent event) {
        if (isRippleEnabled()) {
            ...
            // Adjust the ripple effect's position based on the clipNode's layout properties if needed
            ripple.layoutXProperty()
                  .bind(targetNode.layoutXProperty());
            ripple.layoutYProperty()
                  .bind(targetNode.layoutYProperty());
