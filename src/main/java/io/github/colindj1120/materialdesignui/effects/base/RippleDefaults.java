 ...
 */
package io.github.colindj1120.materialdesignui.effects.base;
...
public class RippleDefaults {
    public static final Status          DEFAULT_RIPPLE_STATE         = Status.ENABLED;
    ...
    public static final Status          DEFAULT_RIPPLE_FILL_STATE    = Status.ENABLED;
    ...
    public static final Status          DEFAULT_RIPPLE_FADE_STATE    = Status.ENABLED;
    ...
    public static final Status          DEFAULT_DROPSHADOW_STATE     = Status.ENABLED;
}
