 ...
 */
package io.github.colindj1120.materialdesignui.factories.effects;
...
public class RippleEffectFactory {
    ...
    private Status          rippleState        = DEFAULT_RIPPLE_STATE;
    ...
    private Status          rippleFillState    = DEFAULT_RIPPLE_FILL_STATE;
    ...
    private Status          rippleFadeState    = DEFAULT_RIPPLE_FADE_STATE;
    ...
    private Status          dropShadowState    = DEFAULT_DROPSHADOW_STATE;
     ...
     *         if the input is null
     */
    public RippleEffectFactory rippleState(Status rippleState) {
     ...
     *         if the input is null
     */
    public RippleEffectFactory rippleFillState(Status rippleFillState) {
     ...
     *         if the input is null
     */
    public RippleEffectFactory rippleFadeState(Status rippleFadeState) {
     ...
     *         if the input is null
     */
    public RippleEffectFactory dropShadowState(Status dropShadowState) {
