 ...
 * designed to be extended by specific skins for different types of text input controls, such as {@link EnhancedTextField}, offering a unified approach to handling text input aesthetics and interactions.
 *
 * <p>
 ...
 *     {@link EnhancedSupportedControlSkin}.</li>
 ...
 * of each control type, while leveraging the common functionality provided by {@code EnhancedTextBaseSkin}.
 * </p>
 *
 * <p>
 ...
 *
 * @param <T>
 *         The type of the {@link EnhancedTextBase} control this skin is associated with, ensuring type safety and seamless integration with the JavaFX skinning mechanism.
 *
 * @author Colin Jokisch
 * @version 1.0.0
 * @see EnhancedSupportedControlSkin
 * @see EnhancedTextField
 * @see EnhancedTextBase
 * @see SkinBase
 */
public abstract class EnhancedTextBaseSkin<T extends EnhancedTextBase<?>> extends EnhancedSupportedControlSkin<T> {
    ...
    /**
     * Constructs an instance of {@code EnhancedTextBaseSkin}, initializing the skin for a given {@code EnhancedTextField} or any of its subclasses. This constructor sets up the fundamental components of the
     ...
     *
     * @param control
     *         The {@code EnhancedTextField} or subclass instance to which this skin is applied. This control provides the text input functionality and additional properties that the skin enhances with Material
     *         Design features.
     */
    protected EnhancedTextBaseSkin(T control) {
        super(control);
    ...
    private void setupCharacterCountLabel() {
        EnhancedTextBase<?> control = getSkinnable();
        ...
        LabelConfigurator.create(characterCountLabel)
                         ...
                         .addVisibleChangeListener(manageLabelVisibility(characterCountLabel, getChildren(), control))
    ...
    private StringExpression createCharacterCountExpression(EnhancedTextBase<?> control) {
    ...
    private ChangeListener<Number> trimTextToMaxCountIfRequired(EnhancedTextBase<?> control) {
