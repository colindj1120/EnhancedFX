...
import io.github.colindj1120.enhancedfx.animation.AnimationManager;
...
import io.github.colindj1120.enhancedfx.factories.property.PropertyConfigurator;
...
import static io.github.colindj1120.enhancedfx.utils.UIUtils.convertToBaseline;

/**
 * The skin class for the {@code EnhancedTextFieldSkin} control.
 *
 * <p>
 * It customizes the appearance and behavior of the text field. This skin extends EnhancedTextBaseSkin and provides additional functionality for handling floating text labels, icons, animations, and layout
 * customization.
 * </p>
 *
 * <p>
 * The {@code EnhancedTextFieldSkin} class is responsible for creating a custom skin for the EnhancedTextField control. It enhances the standard text field by adding features such as floating text labels,
 * icons, animations, and advanced layout management. This class extends {@link EnhancedTextBaseSkin} to leverage existing functionality for handling text input and styling.
 * </p>
 *
 * <p>
 ...
 * label. By extending {@link EnhancedTextBaseSkin}, it inherits basic functionality for managing text input and applying styles.
 * </p>
 *
 * <p>
 * <em>Key Features:</em>
 ...
 * @see EnhancedTextBaseSkin
 */

public class EnhancedTextFieldSkin extends EnhancedTextBaseSkin<EnhancedTextField> {
    ...
    protected final BooleanBindingAssociation floatTextLabelVisibleAndModeInside;
    ...
    public EnhancedTextFieldSkin(EnhancedTextField control) {
        ...
        this.floatTextLabelVisibleAndModeInside = BooleanBindingAssociation.create(binding, this);
    ...
    @NotNull
    private ChangeListener<Boolean> handleTextFieldFocusChange(EnhancedTextField control) {
    ...
    @NotNull
    private ChangeListener<Font> handleTextFieldFontChange(EnhancedTextField control) {
    ...
    @NotNull
    private EventHandler<MouseEvent> handleFloatingTextClicked(EnhancedTextField control, TextField innerField) {
        return e -> {
    ...
    @NotNull
    private static ObjectProperty<Background> getBackgroundProperty(EnhancedTextField control) {
        ...
        ObjectBinding<Background> backgroundBinding = Bindings.when(isTextModeFilledOrNotFloatModeBorder)
                                                              .then(TRANSPARENT_BACKGROUND_PROPERTY)
                                                              .otherwise(control.backgroundProperty());
        return BindingUtils.bindingToObjectProperty(backgroundBinding);
    }

    @NotNull
    private ChangeListener<FloatMode> handleFloatMode(EnhancedTextField control) {
    ...
    @NotNull
    private InvalidationListener handleFloatTargetYInvalid(EnhancedTextField control) {
        return invalidated -> {
    ...
    /**
     * Sets up the animations for the EnhancedTextField control. This method clears any existing animations and sets up the float text animation and reset text animation. If the control's float mode is not
