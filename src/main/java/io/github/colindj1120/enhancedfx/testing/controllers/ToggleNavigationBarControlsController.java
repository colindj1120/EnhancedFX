...
public class ToggleNavigationBarControlsController {
    ...
    private ToggleNavigationBar toggleNavigationBar;
    ...
    private void handleDeleteSelectedButton(){
        checkToggleNavigationBarLoaded();
        Optional<EnhancedToggleButton> btn = toggleNavigationBar.getSelected();
    ...
    public void setToggleNavigationBar(ToggleNavigationBar toggleNavigationBar) {
