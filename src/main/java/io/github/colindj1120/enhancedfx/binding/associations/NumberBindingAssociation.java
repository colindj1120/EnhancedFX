...
import io.github.colindj1120.enhancedfx.binding.base.numberexpressions.NumberExpressionFunctions;
import javafx.beans.binding.NumberBinding;

/**
 * {@code NumberBindingAssociation} class serves as a bridge linking a {@link NumberBinding} to a specific bean object, facilitating
 ...
 * <p>
 * <h2>Usage Example:</h2>
 * Here's how you might use {@code NumberBindingAssociation} to bind the numeric value of a model's property to a
 ...
 * NumberBindingAssociation association = NumberBindingAssociation.create(numericValueBinding, bean);
 ...
 */
public class NumberBindingAssociation implements BindingAssociation<Number>, NumberExpressionFunctions {
    /**
     * Factory method to create a new {@code NumberBindingAssociation}. This method establishes an association between a
     ...
     *
     * @return a new instance of {@code NumberBindingAssociation} that encapsulates the relationship between the provided
     *         {@code NumberBinding} and the bean.
     *
     * @throws IllegalArgumentException
     *         if the bean is {@code null}, ensuring that each {@code NumberBindingAssociation} has a valid bean reference.
     */
    public static NumberBindingAssociation create(NumberBinding binding, Object bean) {
        return new NumberBindingAssociation(binding, bean);
    }

    /**
     * The bean associated with the {@link NumberBinding} in this {@code NumberBindingAssociation}. The bean represents the underlying
    ...
    /**
     * Private constructor to instantiate a {@code NumberBindingAssociation}. Called internally by the
     ...
     */
    private NumberBindingAssociation(NumberBinding binding, Object bean) {
        checkBeanIsNotNull(bean, NumberBindingAssociation.class);
        this.binding = binding;
        this.bean = bean;
    }

    /**
     * Retrieves the {@link NumberBinding} associated with this {@code NumberBindingAssociation}.
     *
    ...
    /**
     * Generates a string representation of this {@code NumberBindingAssociation}, including the binding's and bean's string
     * representations.
     *
     * @return a string representation of this {@code NumberBindingAssociation}.
     */
    @Override
