...
import io.github.colindj1120.enhancedfx.binding.base.numberexpressions.IntegerExpressionFunctions;
import javafx.beans.binding.IntegerBinding;

/**
 * The {@code IntegerBindingAssociation} class is a critical part of the EnhancedFX framework, aiming to bridge the gap between numeric
 ...
 * <p>
 * <h2>Usage Example:</h2>
 * This example demonstrates how to use {@code IntegerBindingAssociation} to bind a model's integer property
 ...
 * IntegerBindingAssociation association = IntegerBindingAssociation.create(volumeLevelBinding, bean);
 ...
 */
public class IntegerBindingAssociation implements BindingAssociation<Number>, IntegerExpressionFunctions {
    /**
     * Factory method to create a new {@code IntegerBindingAssociation}. This method establishes an association between an
     ...
     *
     * @return a new instance of {@code IntegerBindingAssociation} that encapsulates the relationship between the provided
     *         {@code IntegerBinding} and the bean.
     *
     * @throws IllegalArgumentException
     *         if the bean is {@code null}, ensuring that each {@code IntegerBindingAssociation} has a valid bean reference.
     */
    public static IntegerBindingAssociation create(IntegerBinding binding, Object bean) {
        return new IntegerBindingAssociation(binding, bean);
    }

    /**
     * The bean associated with the {@link IntegerBinding} in this {@code IntegerBindingAssociation}. The bean represents the
    ...
    /**
     * Private constructor to instantiate a {@code IntegerBindingAssociation}. Called internally by the
     ...
     */
    private IntegerBindingAssociation(IntegerBinding binding, Object bean) {
        checkBeanIsNotNull(bean, IntegerBindingAssociation.class);
        this.binding = binding;
        this.bean = bean;
    }

    /**
     * Retrieves the {@link IntegerBinding} associated with this {@code IntegerBindingAssociation}.
     *
    ...
    /**
     * Generates a string representation of this {@code IntegerBindingAssociation}, including the binding's and bean's string
     * representations.
     *
     * @return a string representation of this {@code IntegerBindingAssociation}.
     */
    @Override
