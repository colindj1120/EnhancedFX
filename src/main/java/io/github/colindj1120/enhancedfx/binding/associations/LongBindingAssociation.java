...
import io.github.colindj1120.enhancedfx.binding.base.numberexpressions.LongExpressionFunctions;
import javafx.beans.binding.LongBinding;

/**
 * The {@code LongBindingAssociation} class serves as a foundational component within the EnhancedFX framework, aimed at facilitating
 ...
 * LongBindingAssociation association = LongBindingAssociation.create(userAgeBinding, bean);
 ...
 */
public class LongBindingAssociation implements BindingAssociation<Number>, LongExpressionFunctions {
    /**
     * Factory method to create a new {@code LongBindingAssociation}. This method establishes an association between a
     ...
     *
     * @return a new instance of {@code LongBindingAssociation} that encapsulates the relationship between the provided
     *         {@code LongBinding} and the bean.
     *
     * @throws IllegalArgumentException
     *         if the bean is {@code null}, ensuring that each {@code LongBindingAssociation} has a valid bean reference.
     */
    public static LongBindingAssociation create(LongBinding binding, Object bean) {
        return new LongBindingAssociation(binding, bean);
    }

    /**
     * The bean associated with the {@link LongBinding} in this {@code LongBindingAssociation}. The bean represents the underlying
    ...
    /**
     * Private constructor to instantiate a {@code LongBindingAssociation}. Called internally by the
     ...
     */
    private LongBindingAssociation(LongBinding binding, Object bean) {
        checkBeanIsNotNull(bean, LongBindingAssociation.class);
        this.binding = binding;
        this.bean = bean;
    }

    /**
     * Retrieves the {@link LongBinding} associated with this {@code LongBindingAssociation}.
     *
    ...
    /**
     * Generates a string representation of this {@code LongBindingAssociation}, including the binding's and bean's string
     * representations.
     *
     * @return a string representation of this {@code LongBindingAssociation}.
     */
    @Override
