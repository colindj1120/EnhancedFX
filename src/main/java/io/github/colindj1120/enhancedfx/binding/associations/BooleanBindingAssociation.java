...
import io.github.colindj1120.enhancedfx.binding.base.booleanexpressions.BooleanExpressionFunctions;
import javafx.beans.binding.BooleanBinding;

/**
 * {@code BooleanBindingAssociation} serves as a connector between a {@link BooleanBinding} and a bean object, thereby creating a
 ...
 * <p>
 * <h2>Example Usage:</h2>
 * Below is an example illustrating how to use {@code BooleanBindingAssociation} in a JavaFX application to bind a
 ...
 * BooleanBindingAssociation association = BooleanBindingAssociation.create(conditionBinding, bean);
 ...
 */
public class BooleanBindingAssociation implements BindingAssociation<Boolean>, BooleanExpressionFunctions {
    /**
     * Factory method to create a new {@code BooleanBindingAssociation}. This method establishes an association between a
     ...
     *
     * @return a new instance of {@code BooleanBindingAssociation} that encapsulates the relationship between the provided
     *         {@code BooleanBinding} and the bean.
     *
     * @throws IllegalArgumentException
     *         if the bean is {@code null}, ensuring that each {@code BooleanBindingAssociation} has a valid bean reference.
     */
    public static BooleanBindingAssociation create(BooleanBinding binding, Object bean) {
        return new BooleanBindingAssociation(binding, bean);
    }

    /**
     * The bean associated with the {@link BooleanBinding} in this {@code BooleanBindingAssociation}. The bean represents the
    ...
    /**
     * Private constructor to instantiate a {@code BooleanBindingAssociation}. Called internally by the
     ...
     */
    private BooleanBindingAssociation(BooleanBinding binding, Object bean) {
        checkBeanIsNotNull(bean, BooleanBindingAssociation.class);
        this.binding = binding;
        this.bean = bean;
    }

    /**
     * Retrieves the {@link BooleanBinding} associated with this {@code BooleanBindingAssociation}.
     *
    ...
    /**
     * Generates a string representation of this {@code BooleanBindingAssociation}, including the binding's and bean's string
     * representations.
     *
     * @return a string representation of this {@code BooleanBindingAssociation}.
     */
    @Override
