...
import io.github.colindj1120.enhancedfx.beans.property.extendedstyleableproperty.ExtendedStyleableDoubleProperty;
...
import io.github.colindj1120.enhancedfx.factories.styling.ExtendedStyleableDoublePropertyFactory;
...
/**
 * Provides a base class for enhanced controls with additional support for dynamic styling, supporting text, and responsive theme changes. {@code EnhancedSupportedControl} extends the functionality of
 * {@code EnhancedControl} by introducing mechanisms to manage supporting text visibility and positioning, as well as enhancing the control's ability to adapt to theme changes dynamically.
 *
 * <p>
 ...
 *     <li>Theme responsiveness, allowing controls to adapt to theme changes without the need for manual reconfiguration.</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * @see Styleable
 */
public abstract class EnhancedSupportedControl<T extends Control> extends EnhancedControl<T> {
    private static final String ENHANCED_SUPPORTING_TEXT_STYLE = "enhanced-supporting-text";

    private static final   StyleablePropertiesManager STYLES_MANAGER                          = new StyleablePropertiesManager(EnhancedControl.getClassCssMetaData());
    ...
    protected ExtendedStyleableObjectProperty<State>                  supportingTextState;
    protected ExtendedStyleableObjectProperty<SupportingTextPosition> supportingTextPosition;
    protected ExtendedStyleableDoubleProperty                         supportingTextXOffset;
    protected ExtendedStyleableDoubleProperty                         supportingTextYOffset;
    ...
    static {
        ...
        CssFactory<EnhancedSupportedControl<?>, SupportingTextPosition> supportingTextPositionCssFactory;
        supportingTextPositionCssFactory = CssFactory.<EnhancedSupportedControl<?>, SupportingTextPosition>create()
                                                     ...
                                                     .isSettableFunction(node -> checkProperty(node.supportingTextPosition) && node.isSupportingTextEnabled())
        ...
        CssFactory<EnhancedSupportedControl<?>, State> supportingTextStateCssFactory;
        supportingTextStateCssFactory = CssFactory.<EnhancedSupportedControl<?>, State>create()
        ...
        CssFactory<EnhancedSupportedControl<?>, Number> supportingTextXOffsetCssFactory;
        supportingTextXOffsetCssFactory = CssFactory.<EnhancedSupportedControl<?>, Number>create()
                                                    .property("-efx-supporting-text-x-offset")
                                                    .converter(SizeConverter.getInstance())
                                                    .initialValue(0.0)
                                                    .isSettableFunction(node -> checkProperty(node.supportingTextXOffset))
        ...
        CssFactory<EnhancedSupportedControl<?>, Number> supportingTextYOffsetCssFactory;
        supportingTextYOffsetCssFactory = CssFactory.<EnhancedSupportedControl<?>, Number>create()
                                                    .property("-efx-supporting-text-y-offset")
                                                    .converter(SizeConverter.getInstance())
                                                    .initialValue(0.0)
                                                    .isSettableFunction(node -> checkProperty(node.supportingTextYOffset))
    ...
    /**
     * Retrieves the current instance of {@link EnhancedSupportedControl}. This method serves as a contract for subclasses, requiring them to provide their specific implementation of the control. The control is
     * expected to be enhanced and supported, adhering to the specific needs of the implementing UI component.
     *
     * @return The {@link EnhancedSupportedControl} instance associated with this UI component. This control is customized and configured to meet the UI requirements.
     */
    @Override
    protected abstract EnhancedSupportedControl<?> getControl();

    @Override
    protected void loadNewTheme(Observable obs, Theme oldTheme, Theme newTheme) {
        loadNewThemeHelper(Stylesheets.ENHANCED_SUPPORTED_CONTROL, oldTheme, newTheme);
    }
    ...
    protected void setupControl() {
        String stylesheetPath = checkStylesheetPathExists(Stylesheets.ENHANCED_SUPPORTED_CONTROL, this.getClass());
     ...
     *
     * @see EnhancedSupportedControl#SUPPORTING_TEXT_ENABLED_PSEUDO_CLASS
     * @see EnhancedSupportedControl#SUPPORTING_TEXT_DISABLED_PSEUDO_CLASS
     * @see EnhancedSupportedControl#SUPPORTING_TEXT_POS_TOP_PSEUDO_CLASS
     * @see EnhancedSupportedControl#SUPPORTING_TEXT_POS_BOTTOM_PSEUDO_CLASS
     * @see EnhancedSupportedControl#SUPPORTING_TEXT_POS_LEFT_PSEUDO_CLASS
     * @see EnhancedSupportedControl#SUPPORTING_TEXT_POS_RIGHT_PSEUDO_CLASS
     */
    @Override
    ...
    /**
     * Retrieves the supporting text of the EnhancedSupportedControl.
     *
    ...
    /**
     * Retrieves the supporting text state property of the object. The supporting text state property is an instance of `ExtendedStyleableObjectProperty<State>`.
     *
     * @return The supporting text state property of the object.
     */
    public ExtendedStyleableObjectProperty<State> supportingTextStateProperty() {
        return supportingTextState;
    }

    /**
     * Sets the supporting text state of the EnhancedSupportedControl.
     * <p>
    ...
    /**
     * Checks if the supporting text of the EnhancedSupportedControl is currently enabled.
     *
    ...
    /**
     * Retrieves the supporting text position property of the object. The supporting text position property is an instance of `ExtendedStyleableObjectProperty<SupportingTextPosition>`.
     *
     * @return The supporting text position property of the object.
     */
    public ExtendedStyleableObjectProperty<SupportingTextPosition> supportingTextPositionProperty() {
     ...
     */
    public ExtendedStyleableDoubleProperty supportingTextXOffsetProperty() {
     ...
     */
    public ExtendedStyleableDoubleProperty supportingTextYOffsetProperty() {
    ...
    public static List<CssMetaData<? extends Styleable, ?>> getClassCssMetaData() {
        return EnhancedSupportedControl.STYLES_MANAGER.getCssMetaDataList();
    }
