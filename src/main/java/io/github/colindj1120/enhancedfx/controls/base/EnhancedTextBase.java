...
import io.github.colindj1120.enhancedfx.beans.property.extendedstyleableproperty.ExtendedStyleableIntegerProperty;
...
import io.github.colindj1120.enhancedfx.controls.base.inner.innertext.InnerTextInputControl;
import io.github.colindj1120.enhancedfx.enums.State;
import io.github.colindj1120.enhancedfx.enums.controls.enhancedsupportedcontrol.SupportingTextPosition;
...
import io.github.colindj1120.enhancedfx.factories.styling.ExtendedStyleableIntegerPropertyFactory;
...
/**
 * The {@code EnhancedTextBase} class serves as the foundation for creating enhanced text-based controls within the EnhancedFX library. It extends {@link EnhancedSupportedControl} and implements
 * {@link InnerTextInputControl}, providing a rich set of functionalities and styling options for text input controls, such as {@link EnhancedTextField} or {@link EnhancedTextArea}.
 *
 * <p>
 ...
 * @see EnhancedSupportedControl
 * @see EnhancedTextArea
 * @see EnhancedTextField
 */
public abstract class EnhancedTextBase<T extends TextInputControl> extends EnhancedSupportedControl<T> implements InnerTextInputControl<T> {
    ...
    protected ExtendedStyleableIntegerProperty                           maxCharCount;
    protected ExtendedStyleableObjectProperty<State>                     maxCharCountState;
    protected ExtendedStyleableObjectProperty<MaxCharacterCountPosition> maxCharCountPos;
    protected ExtendedStyleableObjectProperty<Color>                     textFill;
    protected ExtendedStyleableObjectProperty<Color>                     promptTextFill;
    protected ExtendedStyleableObjectProperty<TextMode>                  textMode;
    ...
    static {
        ...
        CssFactory<EnhancedTextField, Color> textFillCssFactory;
        textFillCssFactory = CssFactory.<EnhancedTextField, Color>create()
        ...
        CssFactory<EnhancedTextField, Color> promptTextFillCssFactory;
        promptTextFillCssFactory = CssFactory.<EnhancedTextField, Color>create()
        ...
        //region Max Character Count State
        //*****************************************************************
        // Max Character Count State
        //*****************************************************************

        CssFactory<EnhancedTextField, State> maxCharCountStateCssFactory;
        maxCharCountStateCssFactory = CssFactory.<EnhancedTextField, State>create()
        ...
        //endregion Max Character Count State
        ...
        CssFactory<EnhancedTextField, Number> maxCharCountCssFactory;
        maxCharCountCssFactory = CssFactory.<EnhancedTextField, Number>create()
                                           .property("-efx-max-char-count")
                                           .converter(SizeConverter.getInstance())
                                           .initialValue(50)
                                           .isSettableFunction(node -> checkProperty(node.maxCharCount) && node.isMaxCharacterCountEnabled())
        ...
        CssFactory<EnhancedTextField, MaxCharacterCountPosition> maxCharCountPosCssFactory;
        maxCharCountPosCssFactory = CssFactory.<EnhancedTextField, MaxCharacterCountPosition>create()
                                              ...
                                              .isSettableFunction(node -> checkProperty(node.maxCharCountPos) && node.isMaxCharacterCountEnabled())
        ...
        CssFactory<EnhancedTextBase<?>, TextMode> textModeCssFactory;
        textModeCssFactory = CssFactory.<EnhancedTextBase<?>, TextMode>create()
                                       .property("-efx-text-mode")
                                       .converter(EnumConverter.getEnumConverter(TextMode.class))
                                       .initialValue(TextMode.OUTLINED)
                                       .isSettableFunction(node -> checkProperty(node.textMode))
    ...
    /**
     * Constructs an instance of {@code EnhancedTextBase}, initializing the base state for this UI component.
     *
     * <p>
     * This constructor initializes the {@code EnhancedTextBase} component with default settings, ensuring it is ready for use or further customization. It is designed to set up essential properties, listeners,
     * or default styles that are common to all instances of {@code EnhancedTextBase}. The call to the superclass constructor ({@code super()}) ensures that any initialization logic defined in the superclass is
     * also executed, maintaining the integrity of the component's initial state.
     * </p>
     * <p>
     * Usage of this constructor is typical for subclasses or when creating instances of {@code EnhancedTextBase} directly, allowing for further customization through setters or by overriding default behavior.
     * </p>
     */
    ...
    /**
     * Retrieves the current instance of {@link EnhancedTextBase}. This method acts as an abstraction layer, requiring subclasses to provide a concrete implementation that returns the specific instance of the
     ...
     *
     * @return The {@link EnhancedTextBase} instance associated with this text control, tailored with additional features or configurations specific to the control's implementation.
     */
    @Override
    protected abstract EnhancedTextBase<?> getControl();

    @Override
    protected void loadNewTheme(Observable obs, Theme oldTheme, Theme newTheme) {
        loadNewThemeHelper(Stylesheets.ENHANCED_TEXT_BASE, oldTheme, newTheme);
    }
     ...
     * properties such as {@code maxCharCount}, {@code maxCharCountState}, {@code maxCharCountPos}, {@code textFill}, {@code promptTextFill}, and {@code textMode} to enhance the text control's capabilities.
     *
     * <p>
     ...
     *
     * <p>
     * The {@code maxCharCountState} property indicates whether the maximum character count feature is enabled or disabled, using the {@code State} enumeration for its values.
     * </p>
     *
     * <p>
    ...
    protected void setupStyleableProperties() {
        ...
        maxCharCount = ExtendedStyleableIntegerPropertyFactory.builder()
                                                              .bean(this)
        ...
        maxCharCountState = ExtendedStyleableObjectPropertyFactory.<State>builder()
                                                                  .bean(this)
        ...
        maxCharCountPos = ExtendedStyleableObjectPropertyFactory.<MaxCharacterCountPosition>builder()
                                                                .bean(this)
                                                                .name("maxCharacterCountPosition")
                                                                .type(MaxCharacterCountPosition.class)
        ...
        textFill = ExtendedStyleableObjectPropertyFactory.<Color>builder()
                                                         .bean(this)
                                                         .name("textFill")
                                                         .type(Color.class)
        ...
        promptTextFill = ExtendedStyleableObjectPropertyFactory.<Color>builder()
                                                               .bean(this)
                                                               .name("promptTextFill")
                                                               .type(Color.class)
        ...
        textMode = ExtendedStyleableObjectPropertyFactory.<TextMode>builder()
                                                         .bean(this)
                                                         .name("textMode")
                                                         .type(TextMode.class)
                                                         .defaultValue(TextMode.OUTLINED)
    ...
    protected void setupControl() {
        super.setupControl();
        String stylesheetPath = checkStylesheetPathExists(Stylesheets.ENHANCED_TEXT_BASE, this.getClass());
     ...
     *
     * @see EnhancedTextBase#MAX_CHARACTER_COUNT_ENABLED_PSEUDO_CLASS
     * @see EnhancedTextBase#MAX_CHARACTER_COUNT_DISABLED_PSEUDO_CLASS
     * @see EnhancedTextBase#MAX_CHARACTER_COUNT_POS_ABOVE_PSEUDO_CLASS
     * @see EnhancedTextBase#MAX_CHARACTER_COUNT_POS_BELOW_PSEUDO_CLASS
     * @see EnhancedTextField#TEXTMODE_FILLED_PSEUDO_CLASS
     * @see EnhancedTextField#TEXTMODE_OUTLINED_PSEUDO_CLASS
     */
    @Override
     ...
     */
    public State getMaxCharCountState() {
     ...
     */
    public StyleableObjectProperty<State> maxCharCountStateProperty() {
     ...
     */
    public void setMaxCharCountState(State maxCharCountState) {
    ...
    public Boolean isMaxCharacterCountEnabled() {
        return maxCharCountState.valueEquals(State.ENABLED);
    }
    ...
    public Boolean isMaxCharacterCountDisabled() {
        return maxCharCountState.valueEquals(State.DISABLED);
    }
     ...
     */
    public StyleableObjectProperty<MaxCharacterCountPosition> maxCharCountPosProperty() {
     ...
     */
    public StyleableIntegerProperty maxCharCountProperty() {
        return maxCharCount;
    }
    ...
    /**
     * Checks whether the text mode of the EnhancedTextField is set to "outlined".
     *
     ...
     */
    public StyleableObjectProperty<TextMode> textModeProperty() {
        return textMode;
    }
     ...
     */
    private void maxCharacterCountPositionInvalidated(StyleableObjectProperty<MaxCharacterCountPosition> prop, MaxCharacterCountPosition oldValue, Consumer<MaxCharacterCountPosition> oldValueSetter) {
     ...
     */
    private void maxCharacterCountInvalidated(StyleableIntegerProperty prop, Integer oldValue, Consumer<Integer> oldValueSetter) {
        int value = prop.get();
    ...
    /**
     * Handles the invalidation of the {@link StyleableObjectProperty} representing the {@link State} of the text field or area.
     *
     * @param prop
     *         the styleable object property representing the state
     */
    private void maxCharacterCountStateInvalidated(StyleableObjectProperty<State> prop) {
        State state = prop.get();

        pseudoClassStateChanged(MAX_CHARACTER_COUNT_ENABLED_PSEUDO_CLASS, state.equals(State.ENABLED));
        pseudoClassStateChanged(MAX_CHARACTER_COUNT_DISABLED_PSEUDO_CLASS, state.equals(State.DISABLED));
    }

    /**
     * Handles the invalidation of the {@link StyleableObjectProperty} representing the {@link TextMode} of the text field or area.
     *
     * @param prop
     *         the styleable object property representing the text mode
     * @param oldValue
     *         the previous value of the text mode
     * @param oldValueSetter
     *         a consumer to accept the previous value of the text mode
     */
    ...
    /**
     * This method is called when the supporting text position is invalidated. It is used to enforce there be no changes for the supporting text position in an enhanced text field or enhanced text area.
     *
     * @param prop
     *         The styleable object property that represents the supporting text position.
     * @param oldValue
     *         The previous value of the supporting text position.
     * @param oldValueSetter
     *         A consumer that can be used to set the old value if needed.
     *
     * @throws UnsupportedOperationException
     *         If the supporting text position is attempted to be changed from the default position, an exception is thrown.
     */
    @Override
