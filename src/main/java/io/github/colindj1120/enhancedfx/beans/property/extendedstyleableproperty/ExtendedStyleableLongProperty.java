...
/**
 * The {@code ExtendedStyleableLongProperty} class is a specialized implementation of {@link StyleableLongProperty} that incorporates additional functionality to enhance interaction with JavaFX CSS. It provides
 ...
 * </ul>
 * Additionally, {@code ExtendedStyleableLongProperty} is designed with a focus on customization and ease of use,
 ...
 * <em>Example Usage:</em>
 * <pre>{@code
 * ExtendedStyleableLongProperty customProperty = new ExtendedStyleableLongProperty.Builder()
 *         .bean(this)
 *         .name("customProperty")
...
public class ExtendedStyleableLongProperty extends StyleableLongProperty implements ExtendedStyleablePropertyBase {
    ...
    /**
     * Constructs an {@code ExtendedStyleableLongProperty} using the provided {@code Builder} instance. This constructor initializes the property without a default value, configuring it with the options
     ...
     */
    protected ExtendedStyleableLongProperty(Builder builder) {
        super();
        nullCheck(builder, "ExtendedStyleableLongProperty Builder", this.getClass());
    ...
    /**
     * Constructs an {@code ExtendedStyleableLongProperty} with a specified default value, using the provided {@code Builder} instance for other configuration options. This constructor extends the functionality
     ...
     *         if the builder or any required configuration option is null.
     */
    protected ExtendedStyleableLongProperty(Builder builder, Long defaultValue) {
        super(defaultValue);
        nullCheck(builder, "ExtendedStyleableLongProperty Builder", this.getClass());
        this.invalidatedVoidCallback = builder.invalidatedVoidCallback;
        this.invalidatedPropCallback = builder.invalidatedPropCallback;
    ...
    /**
     * The {@code Builder} class for {@code ExtendedStyleableLongProperty} provides a fluent interface for incrementally constructing an {@code ExtendedStyleableLongProperty}. This builder allows for the
     ...
     * <p>
     * Usage of this builder facilitates the creation of a custom {@code ExtendedStyleableLongProperty} tailored to specific needs, enhancing the property's integration within a JavaFX application's styling
     ...
     * </ul>
     * <p>
     * The {@code build()} method finalizes the construction of the {@code ExtendedStyleableLongProperty}, ensuring that all
     ...
     *         .build();
     * </pre>
     * This approach to constructing an {@code ExtendedStyleableLongProperty} provides a clear and modular way to configure
    ...
    public static class Builder {
        ...
        /**
         * Specifies the CSS metadata for the ExtendedStyleableLongProperty. This method sets the CSS metadata, which integrates the property with JavaFX's CSS styling system, allowing for enhanced styling
         * capabilities.
         *
         * @param cssMetaData
        ...
        /**
         * Finalizes the construction of an {@code ExtendedStyleableLongProperty} based on the current configuration of the builder. This method ensures that all required fields have been properly set and that
         ...
         *
         * <p>
         * After passing all checks, the method constructs a new {@code ExtendedStyleableLongProperty}, optionally setting
         ...
         * </p>
         *
         * @return A fully configured {@code ExtendedStyleableLongProperty} instance.
         *
         * @throws IllegalArgumentException
         *         if any required configuration is missing or incorrectly specified.
         */
        public ExtendedStyleableLongProperty build() {
            invalidatorsNullCheck(this.invalidatedVoidCallback, this.invalidatedPropCallback, this.invalidatedCachedCallback, ExtendedStyleableLongProperty.class);
            nullCheck(bean, "ExtendedStyleableLongProperty Bean", ExtendedStyleableLongProperty.class);
            nullCheck(name, "ExtendedStyleableLongProperty Name", ExtendedStyleableLongProperty.class);
            nullCheck(cssMetaData, "ExtendedStyleableLongProperty CssMetaData", ExtendedStyleableLongProperty.class);

            return Optional.ofNullable(defaultValue)
                           .map(v -> new ExtendedStyleableLongProperty(this, v))
                           .orElse(new ExtendedStyleableLongProperty(this));
        }
    }
}
