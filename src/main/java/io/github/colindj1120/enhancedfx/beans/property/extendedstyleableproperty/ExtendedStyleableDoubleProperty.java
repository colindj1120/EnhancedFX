...
/**
 * The {@code ExtendedStyleableDoubleProperty} class is a specialized implementation of {@link StyleableDoubleProperty} that incorporates additional functionality to enhance interaction with JavaFX CSS. It
 ...
 * </ul>
 * Additionally, {@code ExtendedStyleableDoubleProperty} is designed with a focus on customization and ease of use,
 ...
 * <em>Example Usage:</em>
 * <pre>{@code
 * ExtendedStyleableDoubleProperty customProperty = new ExtendedStyleableDoubleProperty.Builder()
 *         .bean(this)
 *         .name("customProperty")
...
public class ExtendedStyleableDoubleProperty extends StyleableDoubleProperty implements ExtendedStyleablePropertyBase {
    ...
    /**
     * Constructs an {@code ExtendedStyleableDoubleProperty} using the provided {@code Builder} instance. This constructor initializes the property without a default value, configuring it with the options
     ...
     */
    protected ExtendedStyleableDoubleProperty(Builder builder) {
        super();
        nullCheck(builder, "ExtendedStyleableDoubleProperty Builder", this.getClass());
    ...
    /**
     * Constructs an {@code ExtendedStyleableDoubleProperty} with a specified default value, using the provided {@code Builder} instance for other configuration options. This constructor extends the
     ...
     *         if the builder or any required configuration option is null.
     */
    protected ExtendedStyleableDoubleProperty(Builder builder, Double defaultValue) {
        super(defaultValue);
        nullCheck(builder, "ExtendedStyleableDoubleProperty Builder", this.getClass());
        this.invalidatedVoidCallback = builder.invalidatedVoidCallback;
        this.invalidatedPropCallback = builder.invalidatedPropCallback;
    ...
    /**
     * The {@code Builder} class for {@code ExtendedStyleableDoubleProperty} provides a fluent interface for incrementally constructing an {@code ExtendedStyleableDoubleProperty}. This builder allows for the
     ...
     * <p>
     * Usage of this builder facilitates the creation of a custom {@code ExtendedStyleableDoubleProperty} tailored to specific needs, enhancing the property's integration within a JavaFX application's styling
     ...
     * </ul>
     * <p>
     * The {@code build()} method finalizes the construction of the {@code ExtendedStyleableDoubleProperty}, ensuring that all
     ...
     *         .build();
     * </pre>
     * This approach to constructing an {@code ExtendedStyleableDoubleProperty} provides a clear and modular way to configure
    ...
    public static class Builder {
        ...
        /**
         * Finalizes the construction of an {@code ExtendedStyleableDoubleProperty} based on the current configuration of the builder. This method ensures that all required fields have been properly set and
         ...
         *
         * <p>
         * After passing all checks, the method constructs a new {@code ExtendedStyleableDoubleProperty}, optionally setting
         ...
         * </p>
         *
         * @return A fully configured {@code ExtendedStyleableDoubleProperty} instance.
         *
         * @throws IllegalArgumentException
         *         if any required configuration is missing or incorrectly specified.
         */
        public ExtendedStyleableDoubleProperty build() {
            invalidatorsNullCheck(this.invalidatedVoidCallback, this.invalidatedPropCallback, this.invalidatedCachedCallback, ExtendedStyleableDoubleProperty.class);
            nullCheck(bean, "ExtendedStyleableDoubleProperty Bean", ExtendedStyleableDoubleProperty.class);
            nullCheck(name, "ExtendedStyleableDoubleProperty Name", ExtendedStyleableDoubleProperty.class);
            nullCheck(cssMetaData, "ExtendedStyleableDoubleProperty CssMetaData", ExtendedStyleableDoubleProperty.class);

            return Optional.ofNullable(defaultValue)
                           .map(v -> new ExtendedStyleableDoubleProperty(this, v))
                           .orElse(new ExtendedStyleableDoubleProperty(this));
        }
    }
}
