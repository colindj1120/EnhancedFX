...
/**
 * The {@code ExtendedStyleableIntegerProperty} class is a specialized implementation of {@link StyleableIntegerProperty} that incorporates additional functionality to enhance interaction with JavaFX CSS. It
 ...
 * </ul>
 * Additionally, {@code ExtendedStyleableIntegerProperty} is designed with a focus on customization and ease of use,
 ...
 * <em>Example Usage:</em>
 * <pre>{@code
 * ExtendedStyleableIntegerProperty customProperty = new ExtendedStyleableIntegerProperty.Builder()
 *         .bean(this)
 *         .name("customProperty")
...
public class ExtendedStyleableIntegerProperty extends StyleableIntegerProperty implements ExtendedStyleablePropertyBase {
    ...
    /**
     * Constructs an {@code ExtendedStyleableIntegerProperty} using the provided {@code Builder} instance. This constructor initializes the property without a default value, configuring it with the options
     ...
     */
    protected ExtendedStyleableIntegerProperty(Builder builder) {
        super();
        nullCheck(builder, "ExtendedStyleableIntegerProperty Builder", this.getClass());
    ...
    /**
     * Constructs an {@code ExtendedStyleableIntegerProperty} with a specified default value, using the provided {@code Builder} instance for other configuration options. This constructor extends the
     ...
     *         if the builder or any required configuration option is null.
     */
    protected ExtendedStyleableIntegerProperty(Builder builder, Integer defaultValue) {
        super(defaultValue);
        nullCheck(builder, "ExtendedStyleableIntegerProperty Builder", this.getClass());
        this.invalidatedVoidCallback = builder.invalidatedVoidCallback;
        this.invalidatedPropCallback = builder.invalidatedPropCallback;
    ...
    /**
     * The {@code Builder} class for {@code ExtendedStyleableIntegerProperty} provides a fluent interface for incrementally constructing an {@code ExtendedStyleableIntegerProperty}. This builder allows for the
     ...
     * <p>
     * Usage of this builder facilitates the creation of a custom {@code ExtendedStyleableIntegerProperty} tailored to specific needs, enhancing the property's integration within a JavaFX application's styling
     ...
     * </ul>
     * <p>
     * The {@code build()} method finalizes the construction of the {@code ExtendedStyleableIntegerProperty}, ensuring that all
     ...
     *         .build();
     * </pre>
     * This approach to constructing an {@code ExtendedStyleableIntegerProperty} provides a clear and modular way to configure
    ...
    public static class Builder {
        ...
        /**
         * Finalizes the construction of an {@code ExtendedStyleableIntegerProperty} based on the current configuration of the builder. This method ensures that all required fields have been properly set and
         ...
         *
         * <p>
         * After passing all checks, the method constructs a new {@code ExtendedStyleableIntegerProperty}, optionally setting
         ...
         * </p>
         *
         * @return A fully configured {@code ExtendedStyleableIntegerProperty} instance.
         *
         * @throws IllegalArgumentException
         *         if any required configuration is missing or incorrectly specified.
         */
        public ExtendedStyleableIntegerProperty build() {
            invalidatorsNullCheck(this.invalidatedVoidCallback, this.invalidatedPropCallback, this.invalidatedCachedCallback, ExtendedStyleableIntegerProperty.class);
            nullCheck(bean, "ExtendedStyleableIntegerProperty Bean", ExtendedStyleableIntegerProperty.class);
            nullCheck(name, "ExtendedStyleableIntegerProperty Name", ExtendedStyleableIntegerProperty.class);
            nullCheck(cssMetaData, "ExtendedStyleableIntegerProperty CssMetaData", ExtendedStyleableIntegerProperty.class);

            return Optional.ofNullable(defaultValue)
                           .map(v -> new ExtendedStyleableIntegerProperty(this, v))
                           .orElse(new ExtendedStyleableIntegerProperty(this));
        }
    }
}
