...
/**
 * The {@code ExtendedStyleableBooleanProperty} class extends {@code StyleableBooleanProperty} to provide enhanced functionality for JavaFX properties that are styleable using CSS. This implementation includes
 ...
 * <em>Example Usage:</em>
 * <pre>
 * ExtendedStyleableBooleanProperty myProperty = new ExtendedStyleableBooleanProperty.Builder()
 *         .bean(this)
 *         .name("myProperty")
...
public class ExtendedStyleableBooleanProperty extends StyleableBooleanProperty implements ExtendedStyleablePropertyBase {
    ...
    /**
     * Initializes an {@code ExtendedStyleableBooleanProperty} with configuration provided by the {@code Builder}. This constructor sets up the property without an explicitly provided default value, relying on
    ...
    private ExtendedStyleableBooleanProperty(Builder builder) {
        super();
        nullCheck(builder, "ExtendedStyleableBooleanProperty Builder", this.getClass());
    ...
    /**
     * Initializes an {@code ExtendedStyleableBooleanProperty} with a specific default value and additional configuration provided by the {@code Builder}. This constructor extends the basic initialization by
    ...
    /**
     * The {@code Builder} class for {@code ExtendedStyleableBooleanProperty} provides a fluent interface for configuring and creating an instance of {@code ExtendedStyleableBooleanProperty}. It allows setting
     ...
     *     set.</li>
     * </ul>
     * The {@code build()} method creates an instance of {@code ExtendedStyleableBooleanProperty} with the configured
    ...
    public static class Builder {
        ...
        /**
         * Builds and returns a new {@code ExtendedStyleableBooleanProperty} instance based on the current configuration of this builder. This method ensures that all necessary parts and callbacks are properly
         ...
         * <p>
         * After validation, the method constructs the {@code ExtendedStyleableBooleanProperty} instance. If a default value
         ...
         *
         * @return A fully configured {@code ExtendedStyleableBooleanProperty} instance.
         *
         * @throws IllegalArgumentException
        ...
        public ExtendedStyleableBooleanProperty build() {
            invalidatorsNullCheck(this.invalidatedVoidCallback, this.invalidatedPropCallback, this.invalidatedCachedCallback, ExtendedStyleableBooleanProperty.class);
            nullCheck(bean, "ExtendedStyleableBooleanProperty Bean", ExtendedStyleableBooleanProperty.class);
            nullCheck(name, "ExtendedStyleableBooleanProperty Name", ExtendedStyleableBooleanProperty.class);
            nullCheck(cssMetaData, "ExtendedStyleableBooleanProperty CssMetaData", ExtendedStyleableBooleanProperty.class);

            return Optional.ofNullable(defaultValue)
                           .map(v -> new ExtendedStyleableBooleanProperty(this, v))
                           .orElse(new ExtendedStyleableBooleanProperty(this));
        }
    }
}
