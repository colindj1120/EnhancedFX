...
import io.github.colindj1120.enhancedfx.factories.configurators.base.interfaces.controls.ButtonBaseConfig;
import io.github.colindj1120.enhancedfx.factories.configurators.base.interfaces.controls.ButtonConfig;
...
public class ButtonConfigurator extends ButtonBaseConfigurator implements ButtonConfig {
    ...
    protected ButtonConfigurator(Button button) {
        super(checkNodeNotNullAndInstanceOf(button, Button.class, ButtonConfigurator.class, "Constructor"));
        this.button = button;
    }
    ...
    public void setNode(Node value) {
        super.setNode(checkNodeNotNullAndInstanceOf(value, Button.class, ButtonConfigurator.class, "setNode"));
