...
import io.github.colindj1120.enhancedfx.factories.configurators.base.interfaces.controls.LabeledConfig;
 ...
 * @see ContentDisplay
 */
public abstract class LabeledConfigurator extends ControlConfigurator implements LabeledConfig {
    /**
    ...
    protected LabeledConfigurator(Labeled labeled) {
        super(checkNodeNotNullAndInstanceOf(labeled, Labeled.class, LabeledConfigurator.class, "Constructor"));
    ...
    public void setNode(Node value) {
        super.setNode(checkNodeNotNullAndInstanceOf(value, Labeled.class, LabeledConfigurator.class, "setNode"));
