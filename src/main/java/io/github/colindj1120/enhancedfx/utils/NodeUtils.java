 ...
 * <pre>{@code
 * double width = NodeUtils.getNodeWidth(myNode, 10.0); // Calculate width with offset
 * double height = NodeUtils.getNodeHeight(myNode); // Calculate height without offset
 * NodeUtils.waitForScene(myNode, () -> {
